...
export const methodStages: MethodStage[] = [
  ...
  },
  {
    ...
    decision: { ar: 'ما الذي يجب حسمه قبل قرار البدء، وما الذي يمكن عزله أو التحقق منه مبكراً؟', en: 'What must be resolved before a start decision, and what can be isolated or verified early?' },
  },
  {
    id: 'build',
    index: '05',
    title: { ar: 'تخطيط التنفيذ والمراجعة', en: 'Implementation Planning & Review' },
    summary: {
      ar: 'نحوّل النطاق المقبول إلى خطة تنفيذ على أجزاء قابلة للمراجعة، لكن التنفيذ نفسه لا يبدأ داخل هذه الرحلة وقبل قرار بدء منفصل.',
      en: 'Turn accepted scope into a plan of reviewable delivery increments, while implementation itself does not begin in this journey or before a separate start decision.',
    },
    question: { ar: 'ما أصغر جزء متماسك نخطط لمراجعته إذا صدر قرار البدء؟', en: 'What is the smallest coherent increment we would plan to review if a start decision is made?' },
    control: { ar: 'تخطيط مراجعات مرحلية وأثر قرار واضح ومنع التوسع الصامت، دون اعتبار الخطة إذناً بالتنفيذ.', en: 'Plan staged reviews, explicit decision trace, and prevention of silent scope growth without treating the plan as permission to implement.' },
    output: { ar: 'خطة تنفيذ قابلة للمراجعة + سجل قرار', en: 'Reviewable implementation plan + decision record' },
    decision: { ar: 'هل ترتبط الخطة بالنطاق المقبول دون أن تضيف التزاماً أو بدءاً تلقائياً؟', en: 'Does the plan map to accepted scope without adding a commitment or automatic start?' },
  },
  {
    id: 'quality',
    index: '06',
  ...
  },
  {
    ...
    summary: {
      ar: 'نحوّل قرار GS الموجّه إلى مدخلات تأسيس مشروع ونطاق يمكن مراجعته قبل أي بدء منفصل.',
      en: 'Turn the guided GS decision into project-bootstrap and scope inputs that can be reviewed before any separate start.',
    },
    question: { ar: 'هل القرار قابل للتسليم كمدخل منظم لقرار بدء مستقل؟', en: 'Can the decision be handed over as structured input for an independent start decision?' },
    control: { ar: 'تثبيت السياق والنطاق والقرارات والاعتماديات والدليل المطلوب دون اعتبارها عقداً أو إذناً تلقائياً بالبدء.', en: 'Package context, scope, decisions, dependencies, and required evidence without treating them as an automatic contract or permission to start.' },
    output: { ar: 'حزمة تأسيس + خط أساس نطاق للمراجعة', en: 'Bootstrap pack + reviewable scope baseline' },
    decision: { ar: 'هل يملك الطرفان مدخلاً واحداً واضحاً لاتخاذ قرار البدء المنفصل؟', en: 'Do both sides share one clear input for the separate start decision?' },
  },
];
